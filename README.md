...
<!-- repository-facts: repo=0.8.0; engineering=5.7.0; plugins=5; engineering-skills=40; hiker-skills=9; desktop=1.3.0; desktop-skills=5; total-skills=54 -->
...
| 智能软件工程平台 | 5.7.0 | 5 个插件、40 个原子 Skill | 从零开发、存量源码接管、B/S、C/S、多会话、大型工程、交互冲突、Git、质量和发布 | 一个轻量自动入口，其余按需加载 |
...
├─ skill-groups/
│  ├─ ai-software-engineering-platform-enterprise/ # 智能软件工程平台：5 个插件、40 个原子 Skill
│  └─ desktop-app-reconstruction-zh/                # 桌面软件等价重建：5 个 Skill
├─ docs/
│  ├─ SKILL_INDEX.md                                # 全部 54 个 Skill 索引
...
- 5 个工程插件、40 个原子 Skill、中文可见名称、轻量路由和行为 Eval；
...
- [智能软件工程平台 5.7 验证报告](skill-groups/ai-software-engineering-platform-enterprise/VALIDATION_REPORT_CN.md)
